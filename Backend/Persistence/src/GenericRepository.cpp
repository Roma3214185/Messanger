...
GenericRepository::GenericRepository(IDataBase& database, ThreadPool* pool)
    : database_(database), pool_(pool) {}

QSqlDatabase& GenericRepository::getThreadDatabase() { return database_.getThreadDatabase(); }
