...
void RedisCache::set(const std::string& key, const nlohmann::json& value,
...
void RedisCache::setPipelines(const std::vector<std::string>& keys, const std::vector<nlohmann::json>& results,
